...
This plugin is based on the <a href="http://wordpress.org/extend/plugins/anfield-live-blogging/" target = "_blank">Live Blogging plugin by Chris Northwood</a>. Fixes some outdated code and allows adding links to the live blog in Twitter updates.

To see this plugin in use, it's probably easiest to watch [this screencast](http://www.pling.org.uk/static/anfield_live_blogging_for_WordPress_2.0.swf).
...
`add_filter('anfield_live_blogging_build_comments', 'twentyten_anfieldliveblogging_comments');
function twentyten_anfieldliveblogging_comments($a)
{
...
Using the `anfield_live_blogging_build_comments` filter, you can return the arguments
...
called 'anfieldliveblogging_hashtag' and it will be appended to all of your tweets.
...
* <a href="http://wordpress.org/extend/plugins/anfield-live-blogging/" target = "_blank">Live Blogging plugin by Chris Northwood</a>
